...
//    public String key="";
    public Recycler_View_Adapter(List<Data> list, Context context) {            final HashMap<String,String> mapper = new HashMap<>();
        ...
        this.list = list;
        list.add(0, new Data("", "UserID", "2019", "TOP", "FN" , "Prof", null, "UID", 1, true, true));
        list.add(new Data("", "UserID", "2050", "TOP", "FN" , "Prof", null, "UID", 1, true, true));
        list.add(new Data("CC", "UserID", "2050", "TOP", "FN" , "Prof", null, "UID", 1, true, true));
